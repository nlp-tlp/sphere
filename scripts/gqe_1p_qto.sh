...
CUDA_VISIBLE_DEVICES=0 python main.py --cuda \
	...
	--clqa_path clqa/pre_trained_clqa/FB15k-237_vec_800_1p \
...
# --clqa_path clqa/pre_trained_clqa/FB15k_vec_800_1p \
# --neural_adj_path neural_adj/ \
# --pre_model "clqa" \
# --model_name "vec" -d 800 -g 24 \
# --fraction 100 --ent_sample 10 \
...
# --clqa_path clqa/pre_trained_clqa/NELL995_vec_800_1p \
